...
class TestFileStorageClass(unittest.TestCase):
    ...
    # test that the data persisted is the correct type and correct format
    # generally i.e {'str': dict} (👍⚡)
    # test if file.json exists after we save from the base model
    # implement a clean up method that would delete the file.json file
    # (you can use the tearDownClass method)
    pass
